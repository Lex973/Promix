/* PROMIX — две бегущие строки с брендами.
   ...
   Плитки приходят из разметки: их печатает PHP из полей админки.
   Скрипт только повторяет ленту до ширины экрана, дублирует её для
   бесшовного цикла и задаёт скорость.
*/
